...
namespace Movies.Pages
{
    public class IndexModel : PageModel
    {
        ...
        public void OnPost()
        {
            ...
            if (search != null)
            {
                Movies = Movies.Where(movie => (movie.Title.Contains(search, StringComparison.OrdinalIgnoreCase) || movie.Director.Contains(search, StringComparison.OrdinalIgnoreCase)));
            ...
            if (sort != null)
            {
                switch (sort) {
                    case "title":
                        Movies = Movies.OrderBy(movie => movie.Title); break;
                    case "director":
                        Movies = Movies.OrderBy(movie => movie.Director); break;
                    case "year":
                        Movies = Movies.OrderBy(movie => movie.Release_Year); break;
                    case "imdb":
                        Movies = Movies.OrderBy(movie => movie.IMDB_Rating); break;
                    case "rt":
                        Movies = Movies.OrderBy(movie => movie.Rotten_Tomatoes_Rating); break;
                }
